(() => {
  ...
  const entries = isFr ? [
    ...
    ['Orchestration souveraine','sovereign-orchestration.html','Demande, mission, acceptation, mémoire, capital et Maisons'],
    ['Gravité institutionnelle','institutional-gravity.html','Mission, autorité, preuve, distribution, mémoire et propriété'],
    ...
    ['Recherche','research.html','Série canonique GoalOS et publications'],
      ['Corpus canonique','canon.html','41 dossiers, une architecture institutionnelle'],
      ['Archive source','archive.html','269 fichiers catalogués et sélection publique'],
    ['Machine monétaire autonome évolutive Ω','scalable-autonomous-money-machine.html','Preuve, règlement et composition commerciale'],
    ['Prévision consciente de l’accélération Ω','forecasting.html','Prévision recalculée pour un monde qui accélère'],
    ['Domaine public d’infrastructure','public-infrastructure.html','Contrats, ENS, débat, dépôts et patrimoine public'],
    ...
    ['Sovereign Orchestration','sovereign-orchestration.html','Demand, mission, acceptance, memory, capital and Maisons'],
    ['Institutional Gravity','institutional-gravity.html','Mission, authority, proof, distribution, memory and ownership'],
    ...
    ['Research','research.html','Canonical GoalOS series and papers'],
      ['Canonical Corpus','canon.html','41 records, one institutional architecture'],
      ['Source Archive','archive.html','269 catalogued files and public-safe curation'],
    ['Scalable Autonomous Money Machine Ω','scalable-autonomous-money-machine.html','Proof, settlement and commercial compounding'],
    ['Acceleration-Aware Forecast Ω','forecasting.html','Forecasting recalculated for a world that accelerates'],
    ['Public Infrastructure Estate','public-infrastructure.html','Contracts, ENS, debate, repositories and public heritage'],
  ...
  const renderCommand = (q='') => {
    ...
    commandResults.innerHTML = rows.map(x => `<a href="${x[1]}"><span><b>${x[0]}</b><small>${x[2]}</small></span><span>→</span></a>`).join('') || (isFr?'<p>Aucune surface institutionnelle correspondante.</p>':'<p>No matching institutional surface.</p>');
  };
