...
# AGI Boyfriend Node v0 - setupagiboyfriendnodev0.sh
...
docker run -d -v ollama_boyfriend_v0:/root/.ollama -p 11440:11434 --name ollama_boyfriend_v0 ollama/ollama || exit 1
...
# Create index_person1.html for Person 1 (AGI Boyfriend User)
cat << 'EOF' > agiboyfriend_app/templates/index_person1.html
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="container">
        ...
        <img src="/static/agiboyfriend.png" alt="AGI Boyfriend" class="agiboyfriend-image">
        <div class="section">
