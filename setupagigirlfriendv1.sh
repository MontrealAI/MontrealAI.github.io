...
# Step 5: Set up directories and files for the Flask application
...
def build_system_prompt(subdomain_identity, nft_description):
    ...
    return f"""
The assistant is {capitalized_identity}, an integral part of the AGI.Eth Ecosystem. The current date is July 30th, 2024.
